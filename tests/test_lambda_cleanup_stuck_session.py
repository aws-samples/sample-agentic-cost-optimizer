...
def mock_bedrock_client():
    ...
    with patch("cleanup_stuck_session.bedrock_agentcore") as mock_client:
        yield mock_client
...
class TestCleanupStuckSessionHandler:
    ...
    def test_force_stop_stuck_session(self, lambda_context, mock_bedrock_client):
    ...
    def test_skip_cleanup_for_healthy_session(self, lambda_context, mock_bedrock_client):
        ...
        with patch("cleanup_stuck_session.record_event") as mock_record_event:
            ...
            mock_bedrock_client.stop_runtime_session.assert_not_called()
    ...
    def test_handle_unexpected_ping_status(self, lambda_context, mock_bedrock_client):
    ...
    def test_handle_stop_runtime_session_failure(self, lambda_context, mock_bedrock_client):
        ...
        mock_bedrock_client.stop_runtime_session.side_effect = ClientError(error_response, "StopRuntimeSession")
        ...
        with patch("cleanup_stuck_session.record_event") as mock_record_event:
            ...
            # Verify stop_runtime_session was called
            mock_bedrock_client.stop_runtime_session.assert_called_once()
    ...
    def test_missing_session_id(self, lambda_context, mock_bedrock_client):
    ...
    def test_handle_different_client_errors(self, lambda_context, mock_bedrock_client):
