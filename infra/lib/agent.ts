      ...
      [
        {
          ...
          reason:
            'Wildcard permissions required by AgentCore Runtime construct for CloudWatch Logs, S3 operations, and workload identity management. Auto-generated by aws-cdk-lib/aws-bedrockagentcore.',
        },
      ],
      true,
    );
